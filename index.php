            ...
            <div class="container">
                <div class="banner">
                    ...
                    <div  class="message-ico">
                        <?php echo($textIndexLabelLanguage); ?>: 
                        <select class="lenguaje-select" id="lenguaje-select">
        ...
        <div class="container blur" id="container-blur">
            ...
            <div class="front-card">
                <div class="front-welcome-text">
                    <h1><?php echo($textIndexTitleWelcomeToHappy); ?></h1>
                    <p><?php echo($textIndexParrafoWelcomeToHappy); ?></p>
                </div>
            </div>
            <div id="login-form">
                <div class="front-signin js-front-signin">
                    <form action="http://www.andreseloysv.com/happy/controller/sessions/sessions.php" class="t1-form signin" method="post">
                        <div class="username field">
                            <input type="text" id="signin-email" class="form-control" name="username_or_email" autocomplete="on" placeholder="<?php echo($textIndexInputPlaceHolderNickName); ?>">
                        </div>
                                ...
                                <tr>
                                    <td class="flex-table-primary">
                                        <div class="password flex-table-form">
                                            <input type="password" id="signin-password" class="form-control" name="password" placeholder="<?php echo($textIndexInputPlaceHolderPassword); ?>">
                                        </div>
                                    </td>
                                    <td class="flex-table-secondary">
                                        <button type="button" class="btn btn-default happy-button" onclick="loging()">
                                            <?php echo($textIndexButtonLogin); ?>
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="remember-forgot">
                            <label class="t1-label remember">
                                ...
                                <span><?php echo($textIndexCheckBoxRememberMe); ?></span>
                            </label>
                            <span class="separator">-</span>
                            <a class="forgot" href="/account/begin_password_reset"><?php echo($textIndexLinkForgotPassword); ?></a>
                        </div>
                        <div id="result"></div>
                ...
                <div class="front-signup js-front-signup">
                    <h2>
                        <strong><?php echo($textIndexTitleRegisterAreYouNewInTwitter); ?></strong> <?php echo($textIndexTitleRegisterAreYouNewInTwitter); ?></h2>
                    ...
                    <form action="http://www.andreseloysv.com/happy/view/register/register.php" class="t1-form signup" id="frontpage-signup-form" method="post">
                        ...
                        <div class="field">
                            <input type="text" class="form-control" autocomplete="off" name="user[name]" maxlength="20" placeholder="<?php echo($textIndexInputFullName); ?> ">
                        </div>
                        <div class="field">
                            <input type="text" class="form-control" autocomplete="off" name="user[email]" placeholder="<?php echo($textIndexInputEmail); ?>">
                        </div>
                        <div class="field">
                            <input type="password" class="form-control" name="user[password]" autocomplete="off" placeholder="<?php echo($textIndexInputPassword); ?>">
                        </div>

                        <input type="hidden" value="" name="context">
                        <input type="hidden" value="26181a377b02ecf923fe1d94d9715298e97fe009" name="authenticity_token">
                        <button type="submit" class="btn signup-btn u-floatRight">
                            <?php echo($textIndexButtonSingUp); ?>
                        </button>
                    </form>
...
<script type="text/javascript">
                                            ...
                                            username_or_email = $("#signin-email").val();
                                                    ...
                                                    $.post("http://www.andreseloysv.com/happy/controller/sessions/sessions.php", {username_or_email: username_or_email}).done(function (data) {
                                            if (data.length > 0) {
                                            ...
                                            $('#lenguaje-select')change(function () {
                                            alert("hola");
                                                    $.post("http://www.andreseloysv.com/happy/changeLanguage.php", {lenguaje - select: "spanish"}).done(function (data) {
                                            if (data.length > 0) {
                                            location.reload();
                                            }
                                            });
