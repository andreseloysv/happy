...
if (is_null($event->photo) or $event->photo === "") {
    ...
    ?>
    <div id="cover-img-drag" style="width: 100%;height: 100%;position: absolute;left: 0px;top: 114px;display: block;background-image: url('http://www.andreseloysv.com/happy/image/event/<?php echo($event->id . "/" . $event->photo); ?>')"></div>  
    <?php
}
?>